...
class BoxMatcher(object):
    ...
    def match_idx_of_box1_idx(self, box1_idx):
        ...
        iou = 0 if box2_idx is None else self._iou_matrix[box1_idx, box2_idx]
        return box2_idx, iou
    ...
    def match_idx_of_box2_idx(self, box2_idx):
        ...
        iou = 0 if box1_idx is None else self._iou_matrix[box1_idx, box2_idx]
        return box1_idx, iou
